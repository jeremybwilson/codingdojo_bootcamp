...
# (optional) Ninja:
# Find a way to validate the data coming in to the shell.  For example, make sure that "name" fields are a minimum length, 
# "email" is a valid email, or that "email" doesn't already exist in the db.