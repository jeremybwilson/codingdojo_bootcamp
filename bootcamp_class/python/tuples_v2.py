...
print "Here is the max in the sequence: ", get_max(dog_x)

def get_sum(sequence):
  sum = 0
  # iterate through values in sequence
  for vals in sequence:
    sum += vals

  return sum

print "Here is the sum of the sequence: ", get_sum(dog_x)

def enumerate_sequence(sequence):
  # iterate through values in sequence
  new_list = list(enumerate(sequence))

  return new_list

print "Here are the enumerated values of the sequence: ", enumerate_sequence(dog_x)
